...
#DoubleML(data=data, y=y, d=d, z=z, xx=x, xL=xl, methods=methods, DML="DML2", nfold=2, est="IV", arguments=arguments, ensemble=ensemble, silent=FALSE, trim=NULL) 
DoubleML <- function(data, y, d,z, xx, xL, methods, DML, nfold, est, arguments, ensemble, silent=FALSE, trim){
#########################################################################
  
  #instiate talbes and check whether treatment effect is binary ; make pool tables 
  ...
  #check for late proper binaryness
  ...
  #create uniforms of data size and 
