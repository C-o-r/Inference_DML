...
par( mfrow = c( 1, 1 ) )
clplot(x,y ,
       ylab="time of Rlasso",xlab	="amount of observations", main="", lwd=5, levels=c(1,2,3,4,5), col=my_colors, showcuts=T , bty="n")


write.csv(y, file = "c1_Rlasso_43_200.csv", row.names = FALSE)