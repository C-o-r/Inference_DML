...
#anther control
intit_pop1=df$ln_init_pop_density
intit_pop1[is.na(intit_pop1)] <- 1 # like in Stata file


#distance
dist= df$distsea

#Table 5_1 Trust of relatives 
#ivreg(Y ~ X + W | W + Z, ... )
test_regression1 = ivreg( Y_TR~ D5+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1
             | dist+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1,data = df)
summary(test_regression1)
summary(test_regression1, diagnostics=TRUE)
# -0.170 vs -0.190 ;wrong standard error; correct R-squared for stage 2; how do I see stage 1 info via ivreg ???
...
#Table 5_2
#ivreg(Y ~ X + W | W + Z, ... )
test_regression2 = ivreg( Y_TN~ D5+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1
             | age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1+dist,data = df)
summary(test_regression2)
#-0.197 vs -0.245

#Table 5_3
test_regression3 = ivreg( Y_TC~ D5+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1
             | age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1+dist,data = df)
summary(test_regression3)


#Table 5_4
test_regression4 = ivreg( Y_tra~ D5+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1
             | age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1+dist,data = df)
summary(test_regression4)


#Table 5_5
test_regression5 = ivreg( Y_ter~ D5+age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1
             | age+age2 +male +urban_dum+district_ethnic_frac+frac_ethnicity_in_district+education_fac+occupation_fac+religion_fac+living_conditions_fac+isocode+mal+mis+ex_con+rail+c1400_+v30_fac+v33+intit_pop1+dist,data = df)
...
#-> estimator differ a bit; correct R-squared stage 2; 
# why ???
...
################################ Inputs ########################################
data1 <-data.frame(Y_TR,D5,dist,age,age2,male,urban_dum,district_ethnic_frac, occupation, religion, education,living_conditions,isocode,mal,mis,ex_con,rail,c1400_,v30_fac,v33,intit_pop)
...
rownames(result1) <- cbind("DML IV estimation for D5: trust relatives", "se(median)",  "se")
...
################################ Inputs ########################################
data2 <-data.frame(Y_TN,D5,dist,age,age2,male,urban_dum,district_ethnic_frac, occupation, religion, education,living_conditions,isocode,mal,mis,ex_con,rail,c1400_,v30_fac,v33,intit_pop)
...
rownames(result2) <- cbind("DML IV estimation for D2: neighbors trust", "se(median)",  "se")
...
#Table5_3 Trust of local council
###################### Loading functions and Data ##############################
...
################################ Inputs ########################################
data3 <-data.frame(Y_TC,D5,dist,age,age2,male,urban_dum,district_ethnic_frac, occupation, religion, education,living_conditions,isocode,mal,mis,ex_con,rail,c1400_,v30_fac,v33,intit_pop)
...
rownames(result3) <- cbind("DML IV estimation for D3: council trust ", "se(median)",  "se")
...
################################ Inputs ########################################
data4 <-data.frame(Y_tra,D5,dist,age,age2,male,urban_dum,district_ethnic_frac, occupation, religion, education,living_conditions,isocode,mal,mis,ex_con,rail,c1400_,v30_fac,v33,intit_pop)
...
rownames(result4) <- cbind("DML IV estimation for D4: intra trust", "se(median)",  "se")
...
################################ Inputs ########################################
data5 <-data.frame(Y_ter,D5,dist,age,age2,male,urban_dum,district_ethnic_frac, occupation, religion, education,living_conditions,isocode,mal,mis,ex_con,rail,c1400_,v30_fac,v33,intit_pop)
...
rownames(result5) <- cbind("DML IV estimation for D5: inter trust ", "se(median)",  "se")
