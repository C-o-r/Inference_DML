...
# Controls
#+black+othrace+ dep+q2+q3+q4+q5+q6+agelt35+agegt54+durable+lusd+husd
#+black+othrace+dep+q2+q3+q4+q5+q6+agelt35+agegt54+durable+lusd+husd
x      <- "female+black+black+othrace+ dep+q2+q3+q4+q5+q6+agelt35+agegt54+durable+lusd+husd"         # use this for tree-based methods like forests and boosted trees
xl     <- "(female+black+black+othrace+ dep+q2+q3+q4+q5+q6+agelt35+agegt54+durable+lusd+husd)^2";     # use this for rlasso etc.
...
ensemble     <- list(methods=c("RLasso",  "Forest", "Nnet"))              # methods for the ensemble estimation
methods      <- c("Boosting", "RLasso","Trees", "Forest", "Nnet", "Ensemble")        # ML methods that are used in estimation
...
result_table1 <- round(result, digits = 3)
...
result_table2 <- round(result, digits = 3)
