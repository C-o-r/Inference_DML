...
#+black+othrace+dep+q2+q3+q4+q5+q6+agelt35+agegt54+durable+lusd+husd
x      <- "female+black"         # use this for tree-based methods like forests and boosted trees
xl     <- "(female+black)^2";     # use this for rlasso etc.
...
methods      <- c("RLasso","Trees", "Forest", "Nnet", "Ensemble")        # ML methods that are used in estimation
